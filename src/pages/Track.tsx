...
import { AlertTriangle, ArrowLeft, Phone, Mail, Monitor, RefreshCw, Printer, CheckCircle, StickyNote } from "lucide-react";
        ...
        {order.unit_checks && (
          <div className="space-y-4 print:hidden">
            {(() => {
              ...
              const hasQcChecks = Object.keys(qcChecks).length > 0;
